...
###########################################################################
# python Select_RO5_ID.v2.py {RO5_y/n} {MW_min} {MW_max} {LogP_max} {HBD_mas} {HBA_max} {RO5_max}
# python Select_RO5_ID.v2.py n
# python Select_RO5_ID.v2.py y 0 500 5 10 5 0
###########################################################################

def copy(zid):
    os.system('cp ../Data/Annotation/'+zid+'.sdf ../Data/PASS')

def RO5(MW_min=0,MW_max=500,LogP_max=5,HBD_max=5,HBA_max=10,RO5_max=0):
    ...
    while True:
        ...
        while True:
            ...
            if line != '':
                ...
                if MW_min<=MW<=MW_max and LogP<=LogP_max and HBD<=HBD_max and HBA<=HBA_max and RO5<=RO5_max:
                    fw.write(zid+'\n')
                    #print(zid)
                    zid_ls.append(zid)
...
def main():
    ...
    if RO5_para == 'n' or RO5_para == 'N':
        ...
        RO5(MW_min,MW_max,LogP_max,HBD_max,HBA_max,RO5_max)
