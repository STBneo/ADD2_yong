...
rm Input.save1.npy
python Clustering_Input_ligand.DBSCAN.v4.yg.py y 0.3 0 > ../Data/Table/DBSCAN1.txt
...
rm Input.save2.npy
python Clustering_Input_ligand.DBSCAN.v4.yg.py y 0.6 2 > ../Data/Table/DBSCAN2.txt
